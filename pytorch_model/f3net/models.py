...
class F3Net(nn.Module):
    def __init__(self, num_classes=1, img_width=256, img_height=256, LFS_window_size=10, LFS_stride=2, LFS_M = 6, mode='Both', device=None):
    ...
    def forward(self, x):
        ...
        # f.squeeze(1)
        # print(f.squeeze(1))
        f = nn.Sigmoid()(f) # Tensor shape: (N, 1)
        return f
