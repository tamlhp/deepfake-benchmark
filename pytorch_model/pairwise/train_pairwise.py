...
def train_pairwise(model,train_set = '../../extract_raw_img',val_set ='../../extract_raw_img',image_size=256,batch_size=16,resume = '',lr=0.001,num_workers=8,checkpoint="checkpoint",epochs=20,print_every=1000):
