...
if __name__ == '__main__':
   ...
   parser.add_argument('--landmark_info_path', type=str, default='landmark_info.p', help='landmarks file from step 1')
   ...
   parser.add_argument('--headpose_save_path', type=str, default='headpose_data.p', help='file to save headpose data')
